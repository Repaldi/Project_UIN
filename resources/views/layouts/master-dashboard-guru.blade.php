			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="{{route('getLatihan')}}" class=""><i class="lnr lnr-dice"></i> <span>Latihan</span></a></li>
						<li><a href="#" class="{{route('forum')}}"><i class="lnr lnr-bubble"></i> <span>Diskusi</span></a></li>
					</ul>
				</nav>
			</div>
		</div>
